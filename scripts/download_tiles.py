#!/usr/bin/env python3
"""
Скрипт для загрузки тайлов карты Кипра для офлайн использования
"""
...
# Границы Кипра + морская зона
MIN_LAT = 34.5
MAX_LAT = 35.7
MIN_LNG = 32.2
MAX_LNG = 34.6

# Уровни зума для загрузки
MIN_ZOOM = 8
MAX_ZOOM = 16
...
USER_AGENT = "CyFishON/1.0 (Offline Map Downloader)"
...
def main():
    ...
    print("🗺️  Загрузка тайлов карты Кипра для офлайн использования")
    ...
    info_file = TILES_DIR / "download_info.txt"
    with open(info_file, 'w', encoding='utf-8') as f:
        f.write(f"Тайлы карты Кипра\n")
